function [J,J0] = jacobian_(NODE, ELEM,s,t)
    format shortEng;
    J = zeros(4,1);
    node = zeros(4,2);
    ...
    a = (1/4) * (-(1-0) * node(1,1) + (1-0) * node(2,1) + (1+0) * node(3,1) - (1+0) * node(4,1));  
    b = (1/4) * (-(1-0) * node(1,2) + (1-0) * node(2,2) + (1+0) * node(3,2) - (1+0) * node(4,2));
    c = (1/4) * (-(1-0) * node(1,1) - (1+0) * node(2,1) + (1+0) * node(3,1) + (1-0) * node(4,1));
    d = (1/4) * (-(1-0) * node(1,2) - (1+0) * node(2,2) + (1+0) * node(3,2) + (1-0) * node(4,2));
    jacobian = [a,b;c,d;];
    J0 = det(jacobian);
end