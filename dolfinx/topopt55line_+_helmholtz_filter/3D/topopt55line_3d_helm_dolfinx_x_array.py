...
def main(nelx, nely, nelz, volfrac, penal, rmin):
    ...
    msh = mesh.create_box(MPI.COMM_WORLD, np.array([[0.0, 0.0, 0.0], [nelx, nely, nelz]]), [nelx, nely, nelz], cell_type=mesh.CellType.hexahedron, ghost_mode=mesh.GhostMode.shared_facet)
