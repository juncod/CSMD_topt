%%%% AN 82 LINE TOPOLOGY OPTIMIZATION CODE BASED ON PDE FILTERING Nov,2010 %%%%
%%%% Corrected 03.04.2011 - restricting the filter radius %%%%
%%%% for PDE filter the mesh has to be able to resolve the PDE solution %%%%
function topopt82_2d(nelx,nely,volfrac,penal,rmin,ft)
if(rmin<2.5), display 'Please use rmin > 2.5'; return; end
%% MATERIAL PROPERTIES
E0 = 1;
Emin = 1e-9;
nu = 0.3;
